        ...
        <section className="text-gray-600 body-font">
          <div className="container mx-auto flex px-5 md:flex-row flex-col items-center">
            ...
            <h1 className="text-[#313131] text-[30px] md:text-[48px] w-[345px] md:w-[680px] h-[125px] md:h-[128px] leading:[42px] md:leading-[64px] text-left font-medium	font-serif font-semibold not-italic  max-w-[680px]">
              ...
              <p className="md:px-0 text-[#71717A] text-left text-[15px] md:text-[24px]  w-[345px] md:w-[680px] h-[62px] md:h-[96px] leading-[21px] md:leading-[32px] font-serif font-normal not-italic">
                Expert-curated internships program enables students to try out careers before making the career decision. Thanks to internet
              </p>
              <div className="space-y-4">
                <div className="bg-[#3780FF] w-[260px] h-[31px] md:w-[400px] md:h-[48px] rounded-[5px] md:rounded-[8px] flex mx-au justify-center items-center cursor-pointer" onClick={() => window.open('https://legislative.gov.in/sites/default/files/dummy-pdf_2_2.pdf')}>
            ...
            <div className="lg:max-w-lg lg:w-full md:w-1/3 w-[168px] -mt-[37px] md-w-full md:-mt-0">
              <Image className="md:ml-[170px] md:mt-[250px] lg:ml-0 lg:mt-0 object-cover object-center rounded" alt="virtual" src="/Helping to Find the Right Career is Priceless-1.png"
                width={651}
                height={484}
                priority />
            </div>
