        ...
        <section className="text-gray-600 body-font">
          <div className="container mx-auto flex px-5 md:flex-row flex-col items-center">
            <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center space-y-5">
              ...
              <p className=" text-[20px] text-[#71717A] max-w-[542px]">Expert-curated internships program enables students to try out careers before making the career decision. Thanks to internet</p>
