        ...
        <section className="text-gray-600 body-font">
          <div className="container mx-auto flex px-5 md:flex-row flex-col items-center">
            <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left text-center space-y-5">
              <h1 className=" md:px-0 text-[#313131] text-[30px] md:text-[48px] w-[345px] md:w-[680px] h-[84px] md:h-[64px] leading:[42px] md:leading-[64px] text-left font-medium	font-serif font-semibold not-italic  max-w-[680px]">
                Goal Planning Session
              </h1>
              <p className=" md:px-0 text-[#71717A] text-left text-[15px] md:text-[24px]  w-[345px] md:w-[680px] h-[80px] md:h-[96px] leading-[20px] md:leading-[32px] font-serif font-normal not-italic">
