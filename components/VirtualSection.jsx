        ...
        <section className="text-gray-600 body-font">
          <div className="container mx-auto flex px-5 md:flex-row flex-col items-center">
            <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0  text-center space-y-5">
              <h1 className="px-4 md:px-0 text-[#313131] text-[30px] md:text-[48px] w-[345px] md:w-[680px] h-[100px] md:h-[125px] leading:[42px] md:leading-[64px] text-left font-medium	font-serif font-semibold not-italic  max-w-[680px]">
                Virtual Internship Program
              </h1>
              <p className="px-4 md:px-0 text-[#71717A] text-left text-[15px] md:text-[24px]  w-[345px] md:w-[680px] h-[62px] md:h-[96px] leading-[21px] md:leading-[32px] font-serif font-normal not-italic">
