    ...
    <>
      <section className="text-gray-600 body-font">
        ...
        <div className="flex flex-col">
          <p className="text-[#222222] font-Inter font-normal text-base leading-8 w-[1062px] h-full ml-[172px] mr-[206px] mt-[80px] ">
          ...
          <p className="text-[#222222] font-Inter font-normal text-base leading-8 w-[1062px] h-full ml-[172px] mr-[206px] mt-[60px] ">
            Lorem Ipsum is simply dummy text of the printing and typesetting
            industry. Lorem Ipsum has been the industry's standard dummy text
            ever since the 1500s, when an unknown printer took a galley of type
            and scrambled it to make a type specimen book. It has survived not
          ...
          <div className="w-[1016px] h-[621px] ml-[240px] mt-[80px]">
            <ImageSlide />
          </div>
          <p className="text-[#222222] font-Inter font-normal text-base leading-8 w-[1062px] mt-[20px] ml-[172px]">
            Lorem Ipsum is simply dummy text of the printing and typesetting
            industry. Lorem Ipsum has been the industry's standard dummy text
            ever since the 1500s, when an unknown printer took a galley of type
            and scrambled it to make a type specimen book. It has survived not
          ...
          <div className="w-[1306px] mt-[20px] mb-[136px] mx-[67px]">
            <ViewCard />
          </div>
        </div>
      </section>
