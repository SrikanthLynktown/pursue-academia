...
const Blogs = () => {
    ...
    return (
        <>
            <div className=" w-[400px]  md:w-[340px] lg:w-[300px] xl:w-[380px] md:h-[396px] shadow-md space-y-8 pb-5 rounded-md overflow-hidden hover:border border-[#4F597B] cursor-pointer mx-aut mt-10  ml-4 mr-4 md:ml-4 md:mr-4">
